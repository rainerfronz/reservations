...
import { mobileValidate, Validator } from "../utils/validate";
import ErrorAlert from "../layout/ErrorAlert";

//THE RESERVATION VIA FORM/FORDATA STATE AND EVENT LISTENER CREATE/CANCEL/SUBMIT
//user story 1 problem 1
export default function ReservationForm() {
  ...
  const theSubmit = (event) => {
    ...
    if (type === "new") {
      if (Validator(formData, setError)) {
